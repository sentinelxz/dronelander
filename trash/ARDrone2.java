...
import eu.hrasko.dronelander.PIDAxisController;
...
public class ARDrone2 {
	...
	// public PIDAxisController controller;
	...
	public ARDrone2(InetAddress drone_addr, int navDataReconnectTimeout, int videoReconnectTimeout) {
	...
	public CommandQueue cmd_queue = new CommandQueue(CMD_QUEUE_SIZE);
	...
	private static int videoReconnectTimeout = 2000; // 1 second
	...
	public void move(float left_right_tilt, float front_back_tilt, float vertical_speed, float angular_speed) throws IOException {
		log.warning("MOVE - " + combinedYawMode + " " + left_right_tilt + " " + front_back_tilt + " " + vertical_speed + " " + angular_speed);
